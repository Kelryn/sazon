...
TRADUCCION_EN_ES: dict[str, str] = {
    ...
    "wholemeal": "integral", "caster": "", "icing": "glas",
    ...
    "palta": "aguacate", "bananas": "platano", "guineo": "platano",
    ...
    "arverjas": "guisantes", "endulzante": "edulcorante",
...
STOP_PREPARACION: frozenset[str] = frozenset(
    {
        ...
        "ralladura", "extracto", "olor", "abejas", "ave", "grano", "granos",
        "rama", "ramas", "cascara", "cascaras", "hojuela", "suficiente", "anillas",
        "anilla", "medianos", "tierna", "tierno", "tiernas", "tiernos",
        "cabezona", "cabezonas", "chica", "chico", "chicas", "chicos", "sancochado",
        "sancochada", "sancochados", "sancochadas", "hervida", "hervido", "hervidas",
        "hervidos", "china", "chinas", "preparada", "preparado", "molidas", "molidos", "pedazo", "pedazos", "pieza", "piezas", "diente", "dientes",
        "cucharada", "cucharadas", "cucharadita", "cucharaditas", "pizca", "manojo", "manojos", "lata", "latas", "bote", "botes", "paquete", "paquetes",
        ...
        "dulce", "dulces", "salado", "salada", "salados", "saladas", "asado", "asada", "asados", "asadas",
        "generoso", "generosa", "colmada", "colmado",
        "rasa", "raso", "opcionales", "necesario",
        ...
        "centimetros", "cubicos", "cc", "cucharas", "cuchara", "serrano", "serranos", "guajillo", "guajillos",
        ...
        "palillos", "bola", "bolas", "cuadrito", "juliana",
